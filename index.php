...
<body>
    ...
    <section class="section3" id="section3">
        ...
        <div class="row" style="height:18em">
            &nbsp; <br>
            &nbsp; <br>
            &nbsp; <br>
            &nbsp; <br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="section5-text">
                                Empieza a <span class="section6-text2">monetizar</span> tu negocio ahora<br><br>
                                </div>
                            </div>
                            <div class="col-md-2"></div>
                        </div>   
    ...
    <section class="subscribete" id="subscribete">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="footer-text2">
                    <li class="finalIcon"><i class="fa fa-map-marker fa-6 xxx"></i> Calle La Reforma #209, Col. San Benito, San Salvador, El Salvador</li><br>
                    <li class="finalIcon"><i class="fa fa-envelope fa-6 xxx"></i> marketing@domencapital.com </li><br>
                    <li class="footer-text3"><i class="fa fa-whatsapp fa-6 xxx"></i> (503) 7745-5161</li>
                </ul>
            </div>
            <div class="col-md-1"></div>
        </div>
...
Si tu continuas navegando en este sitio significa que tu aceptas los términos y Condiciones y politicas de privacidad. Nosotros usamos cookies para brindar la mejor experiencia en nuestro website.
  ...
  <div class="cookies-infobar_wrapper">
    <a href="#" id="cookies-infobar-close" class="cookies-infobar_btn">Aceptar</a>
    <a href="about:blank" class="cookies-infobar_btn">Rechazar</a>
  </div>
